 ...
 * into Backdrop. It's standardizing the conventions for our
...
function hook_register_webcomponent_apps() {
  return array(
    ...
    'open-studio' => array(
      ...
      'title' => t('Open studio'),
      // optional: menu for making this visible in backdrop's menu system
      'menu' => array(
      ...
      // or the app is a stand alone without pulling data from backdrop.
      'data' => array(
